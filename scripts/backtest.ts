...
const lines = [
  ...
  `| **shipping** | ${current.constants.nu} | ${current.constants.home} | ${current.constants.k} | ${current.constants.scale ?? 400} | ${f3(current.logLoss)} | ${f3(current.brier)} | ${pct(current.drawObserved)} / ${pct(current.drawPredicted)} |`,
  `| **tuned** | ${best.constants.nu} | ${best.constants.home} | ${best.constants.k} | ${best.constants.scale ?? 400} | ${f3(best.logLoss)} | ${f3(best.brier)} | ${pct(best.drawObserved)} / ${pct(best.drawPredicted)} |`,
  "",
